...
if (mode == 0):
    ...
    # data = np.load('./data/HighResProbe/D3e17_L30_420-440_15.npz')
    # data2 = np.load('./data/HighResProbe/D3e17_L30_440-460_15.npz')
    # data3 = np.load('./data/HighResProbe/D3e17_L30_460-480_15.npz')
